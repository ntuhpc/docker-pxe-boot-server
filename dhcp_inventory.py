...
def usage():
    print
    print('\tUsage: python dhcp_inventory.py [report|gen]')
    print('\tExample: python dhcp_inventory.py report')
    print('\tExample: python dhcp_inventory.py gen INVENTORY_FILE_PATH SSH_PASSWORD')
    print
